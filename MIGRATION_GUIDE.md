...
Before planning a migration, use the latest supported release. According to [SECURITY.md](./SECURITY.md), the recommended target for upgrades is the latest stable release, currently 0.3.13.

| Version            | Status         | Supported | Notes                                                                                                                                                                |
| ------------------ | -------------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **0.3.2 - 0.3.13** | **Active**     | ✅        | Always upgrade to the latest patch release for maximum security.                                                                                                     |
...
### Upgrading from 0.3.x to 0.3.13
