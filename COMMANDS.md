...
_This command reads all files from `./src/` and outputs the minified versions to `./dist/` while maintaining the folder structure._
...
_This command overrides all supported files in the `./public` directory._
